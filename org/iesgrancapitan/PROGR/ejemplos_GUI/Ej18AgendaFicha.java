...
import org.iesgrancapitan.PROGR.ejemplos_GUI.vistas.Ej18AgendaController;
...
public class Ej18AgendaFicha extends Application {
  ...
  public void start(Stage primaryStage) throws IOException {
    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("vistas/Ej18Agenda.fxml"));
    Parent root = fxmlLoader.load();

    // Damos al controlador acceso a la aplicación principal.
    Ej18AgendaController controller = fxmlLoader.getController();
